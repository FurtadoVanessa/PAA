       ...
       long tempoInicio = System.currentTimeMillis();
        ...
        if(origem == -1){
          //  System.out.println("Todos os paress");
            EscreverArquivo.getInstance().escreverArquivo(dijsktraParaTodosPares(), String.valueOf(arquivoSaida), "Disjktra/"); 
        }else{
        ...
        try {
            Files.write(Paths.get("C:/Users/vanes/Documents/Interdisciplinar/grafos/Disjktra/tempo.txt"), escrita.getBytes(), StandardOpenOption.APPEND);
